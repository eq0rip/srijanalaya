...
<div class="close-newsletter">X</div>
    ...
    <script type="text/javascript">
        ...
        /* ]]> */
    </script><script type="text/javascript" src="http://localhost/srijanalaya/wp-content/plugins/wysija-newsletters/js/front-subscribers.js?ver=2.6.19"></script>
    <!--END Scripts-->

    <div class="widget_wysija_cont html_wysija"><div id="msg-form-wysija-html56507e429e40d-1" class="wysija-msg ajax"></div><form id="form-wysija-html56507e429e40d-1" method="post" action="#wysija" class="widget_wysija html_wysija">
