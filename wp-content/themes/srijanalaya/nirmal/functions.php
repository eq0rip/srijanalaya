 ...
 */
function nirmal_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'nirmal' ),
		'id'            => 'sidebar-1',
		'description'   => '',
...
add_action( 'widgets_init', 'nirmal_widgets_init' );

/**
 * Enqueue scripts and styles.
 */
function nirmal_scripts() {
	wp_enqueue_style( 'nirmal-style', get_stylesheet_uri() );

	wp_enqueue_script( 'nirmal-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20120206', true );

	wp_enqueue_script( 'nirmal-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20130115', true );
