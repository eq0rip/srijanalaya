					...
					<div class="sri-album " data-albumId="<?php echo get_the_ID();?>">
						...
						foreach($album as $albm){
							...
							<div class="col-lg-4 col-md-6 image_wrapper <?php echo $animation;?>" >
								<a href="<?php echo wp_get_attachment_url($imgId);?>"  title="<?php echo $albm['description'];?>" class="swipebox"><img src="<?php $img = wp_get_attachment_image_src($imgId, array(380,225), false); echo $img[0]; ?>" width="380" height="225" alt=""/></a>
